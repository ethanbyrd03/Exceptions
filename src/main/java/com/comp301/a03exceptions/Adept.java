...
public class Adept {
   ...
   * caller.
   */
  public static BufferedReader section5(String urlText) {
    ...
    //    See: https://docs.oracle.com/javase/7/docs/api/java/io/InputStreamReader.html#InputStreamReader(java.io.InputStream)
    ...
    //    BufferedReader.
    //    See: https://docs.oracle.com/javase/7/docs/api/java/io/BufferedReader.html#BufferedReader(java.io.Reader)
